...
private lateinit var bannerAd:FrameLayout
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_launching_your_business, container, false)
        bannerAd=view.findViewById(R.id.LaunchingBannerAd)
        return view
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btnBack2: Button = view.findViewById(R.id.back)
