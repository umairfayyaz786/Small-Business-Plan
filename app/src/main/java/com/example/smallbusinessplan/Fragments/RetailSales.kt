...
class RetailSales : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view:View=inflater.inflate(R.layout.fragment_retail_sales, container, false)
        var visitors=view.findViewById<EditText>(R.id.Lookers)
        var Logins=view.findViewById<EditText>(R.id.Visitors)
        var Shoppers=view.findViewById<EditText>(R.id.Enquirers)
        var Shoppers1=view.findViewById<EditText>(R.id.Enquirers1)
        ...
        var Conversionvisitors=view.findViewById<TextView>(R.id.Lookers_result)
        var ConversionLogins=view.findViewById<TextView>(R.id.Visitor_result)
        var ConversionShoppers=view.findViewById<TextView>(R.id.Enquirers_result)
        var ConversionShoppers1=view.findViewById<TextView>(R.id.Enquirers1_result)
        var ConversionBuyersActual=view.findViewById<TextView>(R.id.BuyersActual_result)

        var TargetVisitor=view.findViewById<TextView>(R.id.tLookers_result)
        var TargetLogins=view.findViewById<TextView>(R.id.tvisitor_result)
        var TargetShopper=view.findViewById<TextView>(R.id.tEnquirers_result)
        var TargetShopper1=view.findViewById<TextView>(R.id.tEnquirers1_result)
        ...
        Calculatebtn.setOnClickListener {
            if (visitors.text.toString().isEmpty() || visitors.text.toString().isBlank()){
                Toast.makeText(context, "Windows Lookers must be required!", Toast.LENGTH_SHORT).show()
            ...
            if (Shoppers1.text.toString().isEmpty() || Shoppers1.text.toString().isBlank()){
                Toast.makeText(context, "Empty Below Enquirers must be required!", Toast.LENGTH_SHORT).show()
                return@setOnClickListener
            }
