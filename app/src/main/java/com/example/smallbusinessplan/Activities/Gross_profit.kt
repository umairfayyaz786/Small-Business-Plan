...
class Gross_profit : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val Cost: EditText = findViewById(R.id.Cost_of_sales)
        val Result: Button = findViewById(R.id.calculate)
        val Grossprofit: TextView = findViewById(R.id.GrossProfit_result)
        val percentage:TextView = findViewById(R.id.GrossProfitpercentage_result)
        ...
        Result.setOnClickListener {
            ...
            if (Cost.text.toString().isEmpty() || Cost.text.toString().isBlank()){
            ...
            val Cost_of_sales = Cost.text.toString().toDouble()
            val Gross_profit =  Cost_of_sales_per_year - Cost_of_sales
            Grossprofit.text = Gross_profit.toString()
            val Gross_profit_Percentage  = (Gross_profit / Cost_of_sales_per_year) * 100
            percentage.text = Gross_profit_Percentage.toString()
